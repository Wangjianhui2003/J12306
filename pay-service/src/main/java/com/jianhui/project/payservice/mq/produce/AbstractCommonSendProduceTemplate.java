...
public abstract class AbstractCommonSendProduceTemplate<T> {
    ...
    public SendResult sendMessage(T messageSendEvent) {
        ...
        try{
            StringBuilder destBuilder = StrUtil.builder().append(baseSendExtendDTO.getTopic());
            if(StrUtil.isNotBlank(baseSendExtendDTO.getTag())){
                destBuilder.append(":").append(baseSendExtendDTO.getTag());
            }
            sendResult = rocketMQTemplate.syncSend(destBuilder.toString(),buildMessage(messageSendEvent,baseSendExtendDTO), baseSendExtendDTO.getSentTimeout());
