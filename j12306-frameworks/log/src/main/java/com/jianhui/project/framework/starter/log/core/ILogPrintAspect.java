...
package com.jianhui.project.framework.starter.log.core;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(com.jianhui.project.framework.starter.log.annotation.ILog) || @annotation(com.jianhui.project.framework.starter.log.annotation.ILog)")
