package com.jianhui.project.orderservice.mq.producer;
...
public class DelayCloseOrderSendProducer extends AbstractCommonSendProduceTemplate<DelayCloseOrderEvent>{
    ...
    public DelayCloseOrderSendProducer(RocketMQTemplate rocketMQTemplate, ConfigurableEnvironment environment) {
